...
class KordinatorComposer
{
    public function compose(View $view)
    {
        ...
        $lamarans = Lamaran::where('status', 'pending')
            ...
            $laporanMagang = Laporan::whereIn('jenis_laporan', $jenisLaporan) // Filter berdasarkan semua jenis laporan
        ...
        $laporanAkhir = LaporanAkhir::where('created_at', '>=', Carbon::now()->subMonth(3))
