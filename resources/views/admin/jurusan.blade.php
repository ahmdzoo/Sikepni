...
<div class="content-wrapper" style="min-height: 100vh;">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-4" style="font-size: 50px; color: white; font-weight: bold;">Data Jurusan</h1>
                </div>
            </div>
        </div>
    </div>
...
function editJurusan(id) {
    $.get('/admin/jurusan/' + id, function(jurusan) {
        $('#editJurusanId').val(jurusan.id);
        $('#editName').val(jurusan.name);
        $('#editJurusanForm').attr('action', '/admin/jurusan/' + jurusan.id);
    });
}

function deleteJurusan(id) {
    $('#deleteJurusanId').val(id);
    $('#deleteJurusanForm').attr('action', '/admin/jurusan/' + id);
}
