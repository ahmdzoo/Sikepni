    ...
    <div class="container-fluid">
      <div class="row m-4">
        ...
        <div class="col-lg-3 col-md-6">
          ...
          {{ $mitras->first()->mitraUser->name }} <!-- Menampilkan nama mitra pertama -->
        @else
      Tidak ada mitra
    @endif
              </h3>
        ...
        <div class="col-lg-3 col-md-6">
          <div class="small-box">
            <div class="inner">
              <h3>
                @if ($mitras->isNotEmpty())
          {{ $mitras->first()->dosenPembimbing->name }} <!-- Menampilkan nama dosen pembimbing pertama -->
        @else
      Tidak ada dosen
    @endif
              </h3>
        ...
        <div class="col-lg-3 col-md-6">
          <div class="small-box">
            <div class="inner">
              <h3>
                @if ($mitras->isNotEmpty())
          {{ $mitras->first()->jurusan->name }} <!-- Menampilkan nama jurusan pertama -->
        @else
      Tidak ada jurusan
    @endif
              </h3>
