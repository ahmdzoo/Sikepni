            ...
            @foreach($mahasiswaDiterima as $item)
              <div class="col-md-4 col-lg-4 mb-4">
                <div class="card h-100">
                  ...
                  <a href="{{ route('mitra.laporan', ['mahasiswa_id' => Crypt::encrypt($item->mahasiswa->id)]) }}" type="button" class="btn btn-primary">Laporan Magang</a>
                  <a href="{{ route('mitra.LaporanAkhir', ['mahasiswa_id' => Crypt::encrypt($item->mahasiswa->id)]) }}" type="button" class="btn btn-secondary">Laporan Akhir</a>
                  </div>
                  </div>
              </div>
              </div>
